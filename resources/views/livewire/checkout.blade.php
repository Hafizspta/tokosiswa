            ...
            <div class="p-10">
                ...
                <div
                    ...
                    <div class="grid grid-cols-2 gap-3 mt-2">
                        <div class="col-span-2">
                            <input id="af-payment-billing-contact"
                            wire:model="data.full_name" 
                            type="text"
                                ...
                                <p class="mt-2 text-xs text-red-600" id="hs-validation-name-error-helper">{{ $message }}</p>
                                @enderror
                        </div>
                        <div>
                            <input type="text"
                ...
                <div
                    ...
                    <div class="mt-2 space-y-3">
                        <input id="af-payment-billing-address"
                            ...
                            <div x-data="{ open: false }" class="relative w-full">
                                ...
                                <input type="text"
                                    ...
                                    <div wire:loading wire:target="region_selector.keyword"
                                        class="absolute right-3 top-3 animate-spin inline-block size-4 border-3 border-current border-t-transparent text-blue-500 rounded-full dark:text-blue-500" role="status" aria-label="loading"><span class="sr-only">Loading...</span>
                                    </div>
                                </div>
                                ...
                                <ul class="absolute z-10 w-full mt-1 overflow-y-auto bg-white border border-gray-200 rounded-b-lg max-h-60"
                                    ...
                                    @foreach ($this->regions as $region)
                                        ...
                                        value="{{ $region->code }}" wire:model.live="region_selector.region_selected" class="sr-only"> 
                                        {{ $region->label }}
                                        </label>
                                        </li>
                                    @endforeach
                ...
                <div class="mt-2 space-y-3">
                    <div class="w-full text-center relative flex justify-center">
                        <div wire:loading wire:target="region_selector.region_selected"
                            class="animate-spin inline-block size-4 border-3 border-current border-t-transparent text-blue-500 rounded-full dark:text-blue-500" role="status" aria-label="loading"><span class="sr-only">Loading...</span>
                        </div>
                    </div>
            ...
            <div class="p-10">
                ...
                <div class="grid gap-5">
                    ...
                    <ul class="flex flex-col mt-3">
                        <li
                            ...
                            <div class="flex items-center justify-between w-full">
                                <span>Sub Total</span>
                                <span>{{ data_get($this->sumaries, 'sub_total_formatted') }}</span>
                            </div>
                        </li>
                        <li
                            class="inline-flex items-center px-4 py-3 -mt-px text-sm text-gray-800 border border-gray-200 gap-x-2 first:rounded-t-lg first:mt-0 last:rounded-b-lg dark:border-neutral-700 dark:text-neutral-200">
                            <div class="flex items-center justify-between w-full">
                                ...
                                <span class="relative">
                                    {{ data_get($this->sumaries, 'shipping_total_formatted') }}
                        ...
                        <li
                            ...
                            <div class="flex items-center justify-between w-full">
                                <span>Total</span>
                                <span>{{ data_get($this->sumaries, 'grand_total_formatted') }}</span>
                            </div>
                        </li>
                    </ul>
                    <!-- End List Group -->
                    <button type="button" 
                        ...
                        Place an Order
                        <div wire:loading
                            class="animate-spin inline-block size-4 border-3 border-current border-t-transparent text-white rounded-full   dark:text-white" role="status" aria-label="loading"><span class="sr-only">Loading...</span>
                        </div>
                    </button>
                </div>
            </div>
